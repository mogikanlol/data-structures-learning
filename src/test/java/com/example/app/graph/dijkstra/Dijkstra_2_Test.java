...
public class Dijkstra_2_Test {

    @Test
    void test_1() {

        int[][] graph = GraphReader.matrixFromResourceFile("data/graph/dijkstra-2/1.txt");
        int[] expected = new int[] {0, 4, 3, 9};

        int start = 0;

        int[] result = Dijkstra_2.execute(graph, start);
    ...
    void test_2() {
        ...
        int[][] graph = GraphReader.matrixFromResourceFile("data/graph/dijkstra-2/2.txt");
    ...
    void test_3() {
        ...
        int[][] graph = GraphReader.matrixFromResourceFile("data/graph/dijkstra-2/3.txt");
    ...
    void test_4(int dest, int expectedDistance) {
        ...
        int result = Dijkstra_2.execute(graph, start, dest);
